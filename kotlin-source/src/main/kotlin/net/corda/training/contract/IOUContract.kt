...
class IOUContract : Contract {
    ...
    override fun verify(tx: LedgerTransaction) {
        ...
        //     ...
        // }
        val cmd = tx.commands.requireSingleCommand<IOUContract.Commands>()
            ...
            is Commands.Issue -> {
                requireThat {
                    ...
                    "Both lender and borrower together only may sign IOU issue transaction." using
                            (cmd.signers.toSet()== out.participants.map { it.owningKey }.toSet())
